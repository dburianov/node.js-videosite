...
echo "Widtth: " ${v_wi} " Heigth: " ${v_he} " Aspect Ratio: " ${v_di}
echo "Duration: "${v_dur} " Frames: " ${v_fr} "FrameRate: " ${v_af}
#ls -l ${file}
exit 0
sleep 1
ffmpeg -re -i ./$1 \
    -vcodec libx264 -profile:v baseline -level 3.1 -g 50 -r 25 -b:v 384k  -b:a 32k   -s 320x180  -acodec libvo_aacenc -ar 44100 -ac 1 -f mp4 ./public/media/$1_320p.mp4 \
    -vcodec libx264 -profile:v baseline -level 3.1 -g 50 -r 25 -b:v 768k  -b:a 64k   -s 640x360  -acodec libvo_aacenc -ar 44100 -ac 1 -f mp4 ./public/media/$1_640p.mp4 \
    -vcodec libx264 -profile:v baseline -level 3.1 -g 50 -r 25 -b:v 2048k -b:a 128k -s 1280x720 -acodec libvo_aacenc -ar 44100 -ac 1 -f mp4 ./public/media/$1_720p.mp4 \
    -vcodec libx264 -profile:v baseline -level 3.1 -g 50 -r 25 -b:v 5120k -b:a 128k -s 1920x1080 -acodec libvo_aacenc -ar 44100 -ac 1 -f mp4 ./public/media/$1_1080p.mp4
